...
import { animations, keyframes } from './src/design-system/tokens/animations';
  ...
  theme: {
    extend: {
      colors: {
        ...
        heritage: {
          DEFAULT: 'hsl(var(--heritage) / <alpha-value>)',
          foreground: 'hsl(var(--heritage-foreground) / <alpha-value>)',
        },
        muted: {
